...
print("#"*44)
print("#    RAZONABILIDAD ESTRES RETROSPECTIVO    #")
...
path_Stress = os.path.join(path_base, f"Estres\\Retrospectivo\\{date_valuation_ddmmyyyy}")
...
path_file_log = os.path.join(path_save,"Log_Razonabilidad_Retrospectivo_"+date_valuation+".txt")

path_file_excel = os.path.join(path_save,"Razonabilidad_Retrospectivo_"+date_valuation+".xlsx")
...
with open(path_file_log, 'w') as f:
    ...
    f.write("#"*46+"\n")
    f.write("#      RAZONABILIDAD ESTRES RETROSPECTIVO    #"+"\n")
...
logger = logging.getLogger('razonabilidad_stres_retrospectivo')
...
list_columns = ['Key', 'Nominal', 'Valoracion']
